...
<a href="../admin-index.php"><img src="../login/img/pngegg.png" class="logo" /></a>
         <ul class="navs-link">
            ...
            <li><a href="history-admin.php?level=admin" class="button-history">History Pembayaran</a></li>
	...
	<?php
		...
		<td><?php echo $nomor++; ?></td>
			...
			<td>
				<a class="hapus" href="hapus-admin.php?id_pembayaran=<?php echo $data['id_pembayaran']; ?>">Hapus</a>					
			</td>
        </tr>
		<?php } ?>
        <!-- and so on... -->
...
<div class="button_cont" align="center">
	<a class="btn-tmbah" href="../bayar_spp/bayar-admin.php" target="_blank" rel="">Input Bayar Spp</a>
</div>		
	<br>
	<br>
