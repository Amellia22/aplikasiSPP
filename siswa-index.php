...
<body id="bodys">
<nav>
<div class="logo"> <a href="#"> SMKN 2 Bandung </a></div>
         <ul class="navs-link">
            <li><a href="history_pembayaran/search_nisn.php" class="button-history">History Pembayaran</a></li>
        ...
        <div class="container">
        <img class="aboutimg" src="login/img/pngegg.png" alt=""> <br> <br> <br>
        </div>
          <div class="isi">
              <h2>Hai Siswa!</h2>
